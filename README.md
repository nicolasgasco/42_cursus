...
|----|--------|--------|-----------|----------|
|**[webserv](https://github.com/nicolasgasco/42_cursus/tree/master/19_webserv)**|C++/C|June 2023| Write your own HTTP server than can be tested with an actual browser|175|
...
|**[cpp_modules](https://github.com/nicolasgasco/42_cursus/tree/master/15_cpp_modules)**|C++|In progress|9 "mini" projects to learn the basics of C++ (98 standard 👴) with a strong focus on OOP|~10 days|
