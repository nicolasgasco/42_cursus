...
do
    case "${flag}" in
        ...
        r) $CC $FLAGS reverse_iterator/reverse_iterator.cpp -o reverse_iterator_tests && ./reverse_iterator/reverse_iterator_tests $DEBUG;;
        p) $CC $FLAGS pair/pair_tests.cpp -o pair_tests && ./pair/pair_tests $DEBUG;;
    esac
done