...
void beginUnitTests(bool isDebug)
{
...

    {
        ...
        }
        {
            ...
            outputAssertion("after post-incrementing vector with 2 elements:", isStrictEqual<int>(*(ownIt++), *(originalIt++), isDebug));
        }
        {
            ft::vector<int> own;
            own.push_back(10);
            ...
            outputAssertion("after pre-incrementing vector with 2 elements:", isStrictEqual<int>(*(++ownIt), *(++originalIt), isDebug));
        }
    }
}
