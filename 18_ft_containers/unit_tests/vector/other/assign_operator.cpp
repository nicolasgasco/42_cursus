...
void assignOperatorUnitTests(bool isDebug)
{
    outputSuiteTitle("ASSIGN OPERATOR");
    {
        ...
        }
        {
            ...
            ft::vector<int> seedOwn;
            seedOwn.push_back(3);
            ft::vector<int> *seedOwnPtr = &seedOwn;
            *seedOwnPtr = seedOwn;

            std::vector<int> seedOriginal;
            seedOriginal.push_back(3);
            std::vector<int> *seedOriginalPtr = &seedOriginal;
            *seedOriginalPtr = seedOriginal;
            outputAssertion("after self-assigning itself:", isStrictEqual<int>((*seedOwnPtr).data(), (*seedOriginalPtr).data(), 1, isDebug));
        }
    }

    {
        ...
        }
        {
            ...
            *seedOwnPtr = seedOwn;
            ...
            std::vector<int> *seedOriginalPtr = &seedOriginal;
            *seedOriginalPtr = seedOriginal;
            outputAssertion("after self-assigning itself:", isStrictEqual<int>((*seedOwnPtr).size(), (*seedOriginalPtr).size(), isDebug));
        }
    }

    {
        ...
        }
        {
            ...
            *seedOwnPtr = seedOwn;
            ...
            std::vector<int> *seedOriginalPtr = &seedOriginal;
            *seedOriginalPtr = seedOriginal;
            outputAssertion("after self-assigning itself:", isStrictEqual<int>((*seedOwnPtr).capacity(), (*seedOriginalPtr).capacity(), isDebug));
        }
    }

    {
        ...
        }
        {
            ...
            *seedOwnPtr = seedOwn;
            ...
            std::vector<int> *seedOriginalPtr = &seedOriginal;
            *seedOriginalPtr = seedOriginal;
            outputAssertion("after self-assigning itself:", isStrictEqual<int>((*seedOwnPtr).max_size(), (*seedOriginalPtr).max_size(), isDebug));
        }
    }
}