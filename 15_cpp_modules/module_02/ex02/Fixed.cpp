...
#define LEAST_INCREMENT_POSSIBLE 1.0039625f
...
Fixed Fixed::operator++(void)
{
    ...
    this->setRawBits(Fixed(this->toFloat() + 1.0039625f).getRawBits());
    return (temp);
}

Fixed Fixed::operator++(int const)
{
    this->setRawBits(Fixed(this->toFloat() + LEAST_INCREMENT_POSSIBLE).getRawBits());
    return (*this);
}
